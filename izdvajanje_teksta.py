...
def removing_shadow(img):
    ...
    # primenjujemo morfolosku operaciju zatvaranja
    closing = cv2.morphologyEx(thresh, cv2.MORPH_CLOSE, kernel, iterations = 2)

    # primenjujemo morfolosku operaciju diletacije
...
plt.imshow(cv2.bitwise_not(img_dilated), cmap='gray')
